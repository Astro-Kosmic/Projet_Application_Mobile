...
import 'package:flutter_application_1/pages/PasHomePage.dart';
import 'package:flutter_application_1/states/MusicState.dart';
import 'package:provider/provider.dart';
import './constants/albums.dart';
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      routes: {
        ...
        '/setting': (context) => SettingsPage(title: 'Settings Page'),
        '/pashome': (context) => PasHomePage(title: 'Pas Home Page')
      }
      )
    );
  }
